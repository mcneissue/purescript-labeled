...
class ComputeExtension (t :: Type -> Type -> Type) (e :: # Type -> Type) (u :: Type) | t -> e u where
  embed :: ∀ s a r r'. IsSymbol s => Lacks s r' => Cons s a r' r => SProxy s -> t a (e r') -> e r
  project :: ∀ s a r r'. IsSymbol s => Lacks s r' => Cons s a r' r => SProxy s -> e r -> t a (e r')
  elim :: Proxy3 t -> u -> e ()
...
instance computeExtensionEither :: ComputeExtension Either Variant Void where
  embed s e = case e of
    ...
    expandCons :: ∀ s i lt gt. IsSymbol s => Cons s i lt gt => SProxy s -> Variant lt -> Variant gt
